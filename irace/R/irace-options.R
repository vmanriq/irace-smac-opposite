...
"x", "x", "p", "p", "p", "p", "p", "p", "s", "x", "p", "p", "p", 
"x", "p", "p", "i", "x", "x", "p", "i", "i", "r", "i", "i", "i", 
"i", "b", "s", "i", "i", "i", "i", "i", "r", "b", "i", "i", "b", 
"b", "s", "b", "r", "p", "p", "x", "i", "b", "b", "i", "i", "x", 
"b", "s", "s", "i", "i", "i", "b", "r", "b"), short = c("-h", 
"-v", "-c", "", "-s", "-p", "", "-l", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "-e", "", "", "", "", "", "", "", "", "", "", "", 
...
"--max-time", "--budget-estimation", "--digits", "--debug-level", 
"--iterations", "--experiments-per-iteration", "--sample-instances", 
"--test-type", "--first-test", "--each-test", "--min-survival", 
"--num-configurations", "--mu", "--confidence", "--deterministic", 
"--seed", "--parallel", "--load-balancing", "--mpi", "--batchmode", 
"--soft-restart", "--soft-restart-threshold", "--test-instances-dir", 
...
"--aclib"), default = c(NA, NA, NA, "", "./scenario.txt", "./parameters.txt", 
"./", "./irace.Rdata", "", "", "", "./Instances", "", "", "", 
"", "./target-runner", "0", "", "", "", "0", "0", "0.02", "4", 
"0", "0", "0", "1", "F-test", "5", "1", "0", "0", "5", "0.95", 
"0", NA, "0", "1", "0", "0", "1", "", "", "", "", "1", "0", "1", 
"1", "2", "", "0", "median", "candidate", "0", "0", "1", "1", 
"0", "0"), description = c("Show this help.", "Show irace package version.", 
